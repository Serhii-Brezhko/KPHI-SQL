...
(4, 'KinoHot',
'Excited for the next part, I could also make a cool short-review about it!'),
...
(5, 'Barack Obama',
'As for me, the system definetely needs some reworking. The comment on top is the true..');
